@extends('main')
@section('content')
<div class="infomation_member_fulldiv_details">

    <div class="infomation_member_fulldiv">
        <div class="button_back_div">
            <a href="/admin/managemember/list" class="button_back">Trở lại</a>
        </div>
        <div class="infomation_membera">
            <div class="infomation_member_divimagea">
            @if(Auth::user()->image != "")
            <i class="fa-solid fa-pen-to-square upload_icon"></i>
            <image onclick="clickopenuploadimage()" class="infomation_member_image" src="/storage/images/{{Auth::user()->image}}" />
            @else 
            <i class="fa-solid fa-pen-to-square upload_icon"></i>
            <image onclick="clickopenuploadimage()" class="infomation_member_image" src="/template/admin/dist/img/userdefault.png" />
            @endif
            </div>
...
<div class="change_image">
    <div class="change_image_div">
        ...
        <form id="formuploadimage" action="/pages/users/upload_image" method="POST" enctype="multipart/form-data">
